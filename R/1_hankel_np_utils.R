...
.input.checks.functions <- function(obj, B, j.max, ql, qu, quantile, n.inf, thrshL2, 
  ...
  # but if it is not missing needs to fulfil requirements
    ...
    warning("While being used in Umashanger & Sriram's original paper,  asymptotically the threshold 'LIC' does not go to 0 slower than the L2 distance and the estimator ist therefore not consistent.",
            call. = FALSE)
  ...
  # but if it is not missing needs to fulfil requirements
    ...
    warning("While being used in Woo & Sriram's original paper, asymptotically the threshold 'AIC' does not go to 0 slower than the L2 distance and the estimator ist therefore not consistent.",
            call. = FALSE)
